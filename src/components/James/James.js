      ...
      <div className="container">
        <div>
          ...
          <div>
            ...
            <Link className="property" to="/COSC3P94_Stage2_V2/house8">
            ...
            <Link className="property" to="/COSC3P94_Stage2_V2/house11">
            ...
            <Link className="property" to="/COSC3P94_Stage2_V2/house6">
